        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                   编辑商品信息
                    <hr>
                    <form  method="post" action="ProductsServlet?action=update"    enctype="multipart/form-data" class="site-form">

                        <input type="hidden" value="${products.id}" name="id">

                        <div class="form-group">
                            <label for="pno">商品编号：</label>
                            <input class="form-control" id="pno" name="pno" value="${products.pno}" type="text" placeholder="请输入商品编号"></input>
                            <span class="errorMsg" style="color:red">${requestScope.msg}</span>
                        </div>
                        <div class="form-group">
                            <label for="pno">商品名称：</label>
                            <input class="form-control" id="name" name="name" value="${products.name}" type="text" placeholder="请输入商品名称"></input>
                        </div>
                        <div class="form-group">
                            <label for="pno">商品价格：</label>
                            <input class="form-control" id="price" name="price" value="${products.price}" type="text" placeholder="请输入商品价格"></input>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="pnum" name="pnum" value="${products.pnum}" type="text" placeholder="请输入商品库存"></input>
                        </div>
